        ...
        <div className="container mt-4">
            ...
            <div className="root mt-3">
                ...
                backgroundColor:"#ffff",
                        '& .MuiInputLabel-root': { color: '#404040' ,fontSize: "12px",
                      fontWeight:400,},
                ...
                <div className='col-7 mt-3 d-flex justify-content-between' style={{
                    ...
                    <TextField sx={{ width: "75%", '& .MuiInputLabel-root': { color: '#404040 !important' },
                        '& .MuiOutlinedInput-root': {
                            '& fieldset': { borderColor: '#404040 !important' },
                            '&:hover fieldset': { borderColor: '#404040 !important' },
                            '&.Mui-focused fieldset': { borderColor: '#404040 !important', borderWidth: '1px !important' },
